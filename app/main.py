...
DATABASE_URL = "mysql+pymysql://jeonghyun:1234@db/homework"
...
Base.metadata.create_all(bind=engine)   # 테이블 DB생성

app = FastAPI()

templates = Jinja2Templates(directory="app/templates") #html파일 사용하게
